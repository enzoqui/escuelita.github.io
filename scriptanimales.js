...
let arrayPalabras =["PERRO", "GATO", "PATO", "CONEJO", "DELFIN", "CEBRA"];
//Arreglo que contiene las ayudas de cada palabra
let ayudas = [
    "Animal doméstico, amigo del hombre, ladra",
    "Animal peludo al que le gusta dormir",
    "Ave que nada en lagos y hace cuac",
    "Tiene largas orejas y come zanahorias",
    "Mamífero marino gris que nada muy rápido",
    "Tiene rayas negras y blancas en su pelaje"
...
function cargarNuevaPalabra(){
    ...
    if(cantPalabrasJugadas>6){
        ...
        arrayPalabras =["PERRO", "GATO", "PATO", "CONEJO", "DELFIN", "CEBRA"];
        ayudas = [
            "Animal doméstico, amigo del hombre, ladra",
    "Animal peludo al que le gusta dormir",
    "Ave que nada en lagos y hace cuac",
