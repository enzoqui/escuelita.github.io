...
let arrayPalabras =["LECHUGA", "AJI", "APIO", "TOMATE", "ZANAHORIA", "PEPINO"];
//Arreglo que contiene las ayudas de cada palabra
let ayudas = [
    "Se usa en ensaladas, es de color verde con hojas",
    "Es una verdura picante de diferentes colores",
    "Verdura con tallos largos de color verde",
    "Verdura redonda de color rojo en el interior",
    "Crece bajo tierra y es de color naranja",
    "Verdura larga de piel verde y pulpa blanca"
...
function cargarNuevaPalabra(){
    ...
    if(cantPalabrasJugadas>6){
        ...
        arrayPalabras =["LECHUGA", "AJI", "APIO", "TOMATE", "ZANAHORIA", "PEPINO"];
        ayudas = [
            "Se usa en ensaladas, es de color verde con hojas",
    "Es una verdura picante de diferentes colores",
    "Verdura con tallos largos de color verde",
